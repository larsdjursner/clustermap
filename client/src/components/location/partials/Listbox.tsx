...
// import { Grade, Genre, selectRoute, setGrade, RouteProperty,  } from "./RouteSlice";
...
// const ListBox = <T extends RouteProperty>({ type }:Props<T>) => {
...
//           }
//         >
//           {Object.values(type.properties).map((option) => (
//             <Listbox.Option
//               className={({ active }) =>
