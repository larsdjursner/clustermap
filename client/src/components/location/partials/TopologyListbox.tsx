...
import { selectRoute, setTopology, Topology } from "../RouteSlice";
...
const TopologyListBox = () => {
  ...
  useEffect(() => {
    dispatch(setTopology({ topology: selectedCategory }));
  ...
  return (
    ...
    >
      ...
      >
        {Object.values(Topology).map((option) => (
          <Listbox.Option
            className={({ active }) =>
...
export default TopologyListBox;
